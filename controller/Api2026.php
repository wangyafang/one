...
$API_URL='http://interface.iagro.cn/api/gateway';
			$get_post_data = array( 'id' => $aid, 'key' => $API_KEY, 'channel' => $post_info['channel'], 'mobile' => $post_info['mobile'], );
...
$API_URL='http://43.139.217.175/api/gateway';
			$get_post_data = array( 'id' => $aid, 'key' => $API_KEY, 'channel' => $post_info['channel'], 'mobile' => $post_info['mobile'], 'electricity_are' => $post_info['electricity_are'], );
			$cmboile=$post_info['mobile'];
			break;
